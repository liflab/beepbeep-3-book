...
{@img ticker/stat-moment-1.png}{A chain of function processors for computing the statistical moment of order n on a trace of numerical events.}{.6}
...
{@img ticker/ticker-example.png}{The chain of processors for Query 3.}{.6}
...
{@img auction/T2P1-modif.png}{Processor graph for the "Auction Bidding" query}{.6}
...
{@img electric/Piping1.png}{The piping of processors for discovering peaks on the original electrical signal. Elements in pink indicate parameters that can be adjusted, changing the behaviour of the pipe.}{.6}
...
{@img electric/Moore.png}{The Moore machine for detecting on/off events for a single appliance.}{.6}
...
{@img pingus/T1P3-modif.png}{The processor chain for processing a stream of events for the Pingus video game.}{.6}
