...
The following code snippet shows a first example of processor called [QueueSource](http://liflab.github.io/beepbeep-3/javadoc/ca/uqac/lif/cep/QueueSource.html).
